...
class SquareSettingsForm extends Component {
  constructor(props) {
    super(props);
    this.state = {
      settings: {
      ...
      <div>
        { !settings.apiKey &&
          <div className="alert alert-info">
            <Translation defaultValue="Square Credentials" i18nKey="admin.paymentSettings.squareCredentials"/>
          </div>
        }
...
SquareSettingsForm.propTypes = {
  onChange: PropTypes.func.isRequired,
  onSubmit: PropTypes.func.isRequired,
  settings: PropTypes.object
};

export default SquareSettingsForm;
