...
import { SquareSettingsForm } from "../components";

class SquareSettingsFormContainer extends Component {
  constructor(props) {
    super(props);
...
SquareSettingsFormContainer.propTypes = {
...
export default composeWithTracker(composer)(SquareSettingsFormContainer);
